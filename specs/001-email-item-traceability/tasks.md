...
- [X] T014 [P] Setup IPC channel definitions in src/main/ipc/channels.ts (22 channels across 8 categories: llm:*, db:*, config:*, app:*, email:*, feedback:*, retention:*, onboarding:*, mode:*)
