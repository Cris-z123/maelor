...
describe('GlobalErrorHandler', () => {
    ...
    describe('reportError', () => {
        ...
        it('should determine severity based on category', () => {
            ...
            errorHandler.reportError(networkError, ErrorCategory.NETWORK, 'TestModule');
            expect(logger.error).toHaveBeenCalledWith(
                'TestModule',
                'Network error',
                networkError,
    ...
    describe('resetErrorTracking', () => {
        ...
        it('should log reset', () => {
            ...
            expect(logger.info).toHaveBeenCalledWith('ErrorHandler', 'Error tracking reset');
        });
    });
    ...
    describe('error categorization', () => {
        ...
        it('should categorize email parsing errors correctly', () => {
            ...
            errorHandler.reportError(error, ErrorCategory.EMAIL_PARSING, 'TestModule');
