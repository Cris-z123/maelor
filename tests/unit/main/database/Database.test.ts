...
describe('DatabaseManager', () => {
  ...
  it('initializes the sqlite database and configures pragmas', () => {
    ...
    expect(fs.mkdirSync).toHaveBeenCalledWith('D:\\userData\\.mailcopilot', { recursive: true });
  ...
  it('reuses the existing instance and exposes helper methods', () => {
    ...
    (DatabaseManager as unknown as { dbPath: string }).dbPath = 'D:\\userData\\.mailcopilot\\app.db';
