...
describe('OnboardingFlow', () => {
  beforeEach(() => {
    ...
    mockApi.detectOutlookDirectory.mockResolvedValue('C:\\Users\\User\\Documents\\Outlook Files');
  ...
  it('completes the 3-step onboarding flow after validation and AI connection succeed', async () => {
    ...
    expect(await screen.findByDisplayValue('C:\\Users\\User\\Documents\\Outlook Files')).toBeInTheDocument();
